...
//         // let buildingNameId = "";
//         // for (let i = 0; i < searchResults.length; i++) {
//         //     if (val.buildingName === searchResults[i].Buildingname) {
//         //         buildingNameId = searchResults[i].Buildingid;
//         //         continue;
//         //     }
//         // }
...
//                                         <div style={{width: 205, textAlign: 'center', alignSelf: 'center'}}>Current venue type </div>
//                                         <div style={{width: 220, textAlign: 'center', alignSelf: 'center'}}>Current venue name </div>
//                                         <div style={{width: 150, textAlign: 'center', alignSelf: 'center'}}>Current location </div>
//                                         <div style={{width: 80, textAlign: 'center', alignSelf: 'center'}}>Current max capacity </div>
//                                         <div style={{width: 120, textAlign: 'center', alignSelf: 'center'}}>Current equipment </div>
//                                     </div>
//                                 </div>
//                                 <div>
...
function EditHome() {
    ...
    return (
        <>   
            {Cookies.get("name") !== undefined && Cookies.get("id") !== undefined
                ? <Layout2 id={Cookies.get("id")} name={Cookies.get("name")} action="Editing booking">
                    <div className="parent">
                        <div className="home-page">
                            {/* <div className="venue-list">
                                <div className="display-selected-venue-header">
